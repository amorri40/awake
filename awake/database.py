...
class Database(object):
    ...
    """
    default_tags = {
        'IO:FF04': 'IO:DividerRegister',
        'IO:FF05': 'IO:TimerCounter',
        'IO:FF06': 'IO:TimerModulo',
        'IO:FF07': 'IO:TimerControl',
        'IO:FF40': 'IO:LCDControl',
        'IO:FF41': 'IO:LCDStatus',
        'IO:FF42': 'IO:ScrollY',
        'IO:FF43': 'IO:ScrollX',
        'IO:FF44': 'IO:YCoordinate',
        'IO:FF45': 'IO:YCompareValueToTriggerInterrupt',
        'IO:FF46': 'IO:DMATransferToTransferMemoryToSpriteTable',
        'IO:FF47': 'IO:BackgroundPaletteData',
        'IO:FF48': 'IO:ObjectSpritePallette0',
        'IO:FF49': 'IO:ObjectSpritePallette1',
        'IO:FF4A': 'IO:WindowYPosition',
        'IO:FF4B': 'IO:WindowXPosition',
        'IO:FFFF': 'IO:InterruptEnable',
        'IO:FF0F': 'IO:InterruptFlag',
    }
